...
import frog1 from '@/assets/nft5.png';
...
const confirmPurchase = async () => {
  ...
  try {
    ...
    const newNftCount = (userData.nft5 || 0) + 1;
    const newScore = userData.score - 50000;
