...
import frog1 from '@/assets/nft2.png';
...
const confirmPurchase = async () => {
  ...
  try {
    ...
    const newNftCount = (userData.nft2 || 0) + 1;
    const newScore = userData.score - 20000;
