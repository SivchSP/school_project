...
import frog1 from '@/assets/nft4.png';
...
const confirmPurchase = async () => {
  ...
  try {
    ...
    const newNftCount = (userData.nft4 || 0) + 1;
    const newScore = userData.score - 40000;
