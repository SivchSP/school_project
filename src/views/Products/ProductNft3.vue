...
import frog1 from '@/assets/nft3.png';
...
const confirmPurchase = async () => {
  ...
  try {
    ...
    const newNftCount = (userData.nft3 || 0) + 1;
    const newScore = userData.score - 30000;
